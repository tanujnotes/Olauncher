...
import app.elauncher.databinding.FragmentAppDrawerBinding
import app.elauncher.helper.deletePinnedShortcut
...
class AppDrawerFragment : BaseFragment() {
    ...
    private fun initViews() {
        ...
        else if (flag in Constants.FLAG_SET_HOME_APP_CELL..Constants.FLAG_SET_CALENDAR_APP)
